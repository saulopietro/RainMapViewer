...
public class SideMenuComponent extends JPanel {
    ...
    private JPanel criarItemMenu(String iconPath, String labelText, JLabel labelRef, Runnable onClick) {
    ...
    panel.addMouseListener(new MouseAdapter() {
        ...
        public void mouseClicked(MouseEvent evt) {
            onClick.run();  // chama a ação associada
        }
    });
